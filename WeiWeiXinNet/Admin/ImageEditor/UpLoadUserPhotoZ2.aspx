<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpLoadUserPhotoZ2.aspx.cs" Inherits="ZoomImageDemo.UpLoadUserPhotoZ2" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/CutPicZ1.js"></script>
    ...
    <div>
     <div class="left">
         ...
         <div id="CurruntPicContainer">
            ...
            <div class="photocontainerZ">
                <asp:Image ID="imgphoto" runat="server" ImageUrl="~/admin/ImageEditor/image/man200.GIF" />
            </div>
         </div>
         <!--Step 2-->
         <div id="Step2Container">
           <div class="uploadtooltip">您可以拖动图片以裁剪最佳位置</div>                              
                   <div id="Canvas" class="uploaddiv">
                            ...
                            <div id="ImageDragContainerZ">                               
                               <asp:Image ID="ImageDrag" runat="server" ImageUrl="~/admin/ImageEditor/image/blank200.jpg" CssClass="imagePhoto" ToolTip=""/>                                                        
                            </div>
                            <div id="IconContainerZ">                               
                               <asp:Image ID="ImageIcon" runat="server" ImageUrl="~/admin/ImageEditor/image/blank200.jpg" CssClass="imagePhoto" ToolTip=""/>                                                        
                            </div>                          
                    </div>
                    <div class="uploaddiv">
                       <table>
                    ...
                    框宽： <asp:TextBox ID="txt_DropWidth" 
                            runat="server"  Text="200" Width="30px"></asp:TextBox> 
                    框高： <asp:TextBox ID="txt_DropHeight" runat="server" Text="200" Width="30px"></asp:TextBox> 
         ...
         <div id="Step1Container">
            ...
            <div id="uploadcontainer">
                ...
                <div class="uploaddiv"><asp:Button ID="btnUpload" runat="server" Text="上 传" onclick="btnUpload_Click" />&nbsp; <input type=button value="关闭" onclick="foo();"> 
                    <input type=text name="txt" id="txt" value="123456">
                    <asp:Button ID="ButtonOne" runat="server" onclick="ButtonOne_Click" Text="Button" />
                </div>
            </div>
