...
var ICON_SIZE_W = 280;  //截取框的大小，方形
var ICON_SIZE_H = 156;  //截取框的大小，方形


var LEFT_EDGE = (CANVAS_WIDTH - ICON_SIZE_W) / 2; //82 2
var TOP_EDGE = (CANVAS_HEIGHT - ICON_SIZE_H) / 2; //73 55
...
$(window).load(function() {
    ...
    //计算缩放比例开始
    var minFactor = ICON_SIZE_W / Math.max(realWidth, realHeight);
    if (ICON_SIZE_W > realWidth && ICON_SIZE_H > realHeight) {
        minFactor = 1;
    }
