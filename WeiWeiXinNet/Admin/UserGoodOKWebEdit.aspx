<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGoodOKWebEdit.aspx.cs" Inherits="WeiWeiXinNet.admin.UserGoodOKWebEdit" %>
...
<body>
    <form id="weweixin_form" runat="server">
         <asp:Panel runat="server" ID="Panel2" Visible="false">
             ...
             <iz:FileManager ID="FileManager1" runat="server" Height="480px" Width="800px" OnExecuteCommand="FileManager1_ExecuteCommand"
            Visible="true">
            <RootDirectories>
