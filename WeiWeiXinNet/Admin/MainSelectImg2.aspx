<%@ Page Title="µÇÂ¼" Language="C#"   AutoEventWireup="True"
    CodeBehind="MainSelectImg2.aspx.cs" Inherits="WeiWeiXinNet.admin.MainSelectImg2" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function foo() {
            window.close();
            window.opener.document.getElementById("txt3").value = document.getElementById("WeTextBoxTwo").value
            window.opener.document.getElementById("Image2").setAttribute("src", document.getElementById("WeTextBoxTwo").value);
        } 
