<%@ Page Title="登录" Language="C#"   AutoEventWireup="True"
    CodeBehind="MainEditImg.aspx.cs" Inherits="WeiWeiXinNet.admin.MainEditImg" %>
...
<body  >
	...
	<div>
        <input type=button value="关闭" onclick="foo();"> 选择的图片<asp:TextBox ID="WeTextBoxTwo" 
            Name="WeTextBoxTwo" runat="server" Width="694px"></asp:TextBox>
        <br />
