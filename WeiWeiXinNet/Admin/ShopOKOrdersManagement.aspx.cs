...
namespace WeiWeiXinNet.admin
{
    ...
    /// 订单索引 
    /// </summary>
    public partial class ShopOKOrdersManagement : System.Web.UI.Page
    {
    ...
    public void ShowList()
    {
        ...
        //得到订单文件夹
        string PathFile = System.IO.Path.Combine(Server.MapPath("~"), "user_dir/sysuser/shangcheng/olddingdan");               
        ...
        try
        {
            ...
            for (int i = 0; i < mDir.Length; i++)
            {
               ...
               // string aH = "<a href='javascript:void(0);' onclick='javascript:PopUpWindow('UserGoodWebEdit.aspx?gd=" + name + "',100,100,880,490);' style='color: #FF0000'>";
                string aH = " <a href=\"javascript:void(0);\" onclick=\"javascript:PopUpWindow('UserGoodOKWebEdit.aspx?gd=" +name +"',10,10,960,540);\"  style=\"color: #FF0000\">";
