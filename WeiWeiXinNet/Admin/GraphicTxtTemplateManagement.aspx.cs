...
namespace WeiWeiXinNet.admin
{
    ...
    /// 模板管理
    /// </summary>
    public partial class GraphicTxtTemplateManagement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ButtonSix.Attributes.Add("OnClick", "return  jsLoad();");
            ...
            {
                //系统目录 存放目录
                string PathFileOne = System.IO.Path.Combine(Server.MapPath("~"), "USER_DIR\\SYSUSER\\NEWS\\news.HTM");
        ...
        {
            //系统目录 存放目录
            string PathFileOne = System.IO.Path.Combine(Server.MapPath("~"), "USER_DIR\\SYSUSER\\news\\news.HTM");
