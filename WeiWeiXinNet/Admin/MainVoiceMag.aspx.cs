...
namespace WeiWeiXinNet.admin
{
    ...
    /// 
    /// </summary>
    public partial class MainVoiceMag : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                foreach (FileManagerItemInfo item in FileManager1.SelectedItems)
                {
                 ...
                 //   Response.Write("<javascript>javascript:PopUpWindow('./ImageEditor/UpLoadUserPhotoZ.aspx',100,100,600,500);</javascript>");
                    ...
                    Response.Redirect("./ImageEditor/UpLoadUserPhotoZ2.aspx");
        ...
        if (e.CommandName == "GETDATAC")
        {
            ...
            else
            {
                ...
                foreach (FileManagerItemInfo item in FileManager1.SelectedItems)
                {
                    ...
                    //     <a href="javascript:void(0);" onclick="javascript:PopUpWindow('./ImageEditor/UpLoadUserPhotoC.aspx',100,100,600,500);">点击上传照片</a>
                    //   Response.Write("<javascript>javascript:PopUpWindow('./ImageEditor/UpLoadUserPhotoZ.aspx',100,100,600,500);</javascript>");
                 //   Response.Write("<javascript>javascript:PopUpWindow('./ImageEditor/UpLoadUserPhotoC.aspx',100,100,600,500);</javascript>");

                    Response.Redirect("./ImageEditor/UpLoadUserPhotoC2.aspx");
    ...
    {
        // 一个
        Response.Redirect("./player/index.html");
        
    }

    protected void ButtonFour_Click(object sender, EventArgs e)
    {
        Response.Redirect("./Recorder/index.html");
    }
