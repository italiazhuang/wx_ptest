<%@ Page Title="µÇÂ¼" Language="C#"   AutoEventWireup="True"
    CodeBehind="MainSelectGoodImg.aspx.cs" Inherits="WeiWeiXinNet.admin.MainSelectGoodImg" %>
    ...
    <div>
        <div>
            ...
            <iz:FileManager ID="FileManager1" runat="server" Height="400" Width="800" OnExecuteCommand="FileManager1_ExecuteCommand"
                ...
                <RootDirectories>
                    <iz:RootDirectory DirectoryPath="~/USER_DIR/SYSUSER/ShangCheng/goods/img" Text="Í¼Æ¬ÎÄ¼þ¼Ð" />
                </RootDirectories>
