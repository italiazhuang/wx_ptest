 ...
 *    QQ群：172036441
 *    授权：个人或公司 运营自身微信公众号使用和二次开发自由使用，或者针对特定的单个用户进行二次开发自由使用，禁止重新包装后批量转卖
 */
using System;
...
namespace WeiWeiXinNet.admin
{
    ...
    /// 微表单 资源管理
    /// </summary>
    public partial class MyTableAppResManagement : System.Web.UI.Page
    {
        ...
        rootDirectory.DirectoryPath = "~/user_dir/SYSUSER/Table/IMG/";
        rootDirectory.Text = "表单图片素材";
