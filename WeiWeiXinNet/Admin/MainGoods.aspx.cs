...
namespace WeiWeiXinNet.admin
{
    ...
    /// 商品管理
    /// </summary>
    public partial class MainGoods : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (md5 == null)
            {
             ...
             string PathFile = System.IO.Path.Combine(Server.MapPath("~"), "USER_DIR\\SYSUSER\\Shangcheng\\goods.dll"); //图文 关键词回复目录);    
        ...
        protected void TreeView1_SelectedNodeChanged1(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < CMsgData.Items.Count; i++)
            {
                if (CMsgData.Items[i].Title == Label2.Text)
                {
                    ...
                    WeTextBoxTwo.Text = CMsgData.Items[i].Description; //价格

                    Image1.ImageUrl = CMsgData.Items[i].PicUrl; //显示图标
                    ...
                    {
                        //读取文件
                        string PathFile = System.IO.Path.Combine(Server.MapPath("~"), "USER_DIR\\SYSUSER\\Shangcheng\\goods\\" + CMsgData.Items[i].Url);
        ...
        protected void Button23_Click(object sender, EventArgs e)
        {
            ...
            {
                string Name = "商品" + j.ToString("D2");
                bool IsOK=true ;

                string PathFile = System.IO.Path.Combine(Server.MapPath("~"), "USER_DIR\\SYSUSER\\Shangcheng\\goods\\page" + j.ToString() + ".htm");
        ...
        protected void Button21_Click(object sender, EventArgs e)
        {
            ...
            NewsItem myItem = new NewsItem();
             ...
             string PathFile = System.IO.Path.Combine(Server.MapPath("~"), "USER_DIR\\SYSUSER\\Shangcheng\\goods\\" + myItem.Url);
             System.IO.File.WriteAllText(PathFile, TextBoxEDIT.Text, System.Text.Encoding.UTF8);

             myItem.Description = WeTextBoxTwo.Text;// 
