...
namespace WeiWeiXinNet.admin
{
    ...
    /// 每日英语数据 
    /// </summary>
    public partial class EveryDayEnglishData : System.Web.UI.Page
    {
        ...
        {
            //系统目录 存放目录
            string PathFileOne = System.IO.Path.Combine(Server.MapPath("~"), "USER_DIR\\SYSUSER\\SYSSET\\EveryDayEnglishData.dll");
            String[] TXTSET = { WeTextBoxOne.Text,   WeTextBoxThree.Text };
