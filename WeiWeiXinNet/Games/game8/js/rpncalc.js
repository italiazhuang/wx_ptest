...
function make_layouts(pad, display, stack) {
    ...
    var oneLayout = [
        [{
            ...
            text: "<span class='btnFnText btnFont'>R&darr;</span>",
            fcn: function() {
                stack.rolldown(display)
            }
        }, {
            text: "<span class='btnFnText btnFont'>e</span>",
            fcn: function() {
        ...
        [{
            text: "<span class='btnFnText btnFont'>Sin<sup>-1</sup></span>",
            fcn: function() {
        ...
        [{
            text: "<span class='btnFnText btnFont'>Sin</span>",
            fcn: function() {
            ...
            text: "<span class='btnFnText btnFont'>Floor</span>",
            fcn: function() {
                pad.unaryOp(Math.floor)
            }
        }],
        [{
            text: "<span class='btnFnText btnFont'><span style='font-size:138%;'>&radic;</span><span style='margin-left:-0.075em; border-top:0.25ex solid;'>x</span></span>",
            fcn: function() {
                pad.unaryOp(Math.sqrt)
            }
        }, {
            text: "<span class='btnFnText btnFont'>x&harr;y</span>",
            fcn: pad.xchng
        }, {
